...
//  val sql = "select * from zhilian_test.equipment where platfromid='ff658af2-77e4-4983-a515-f8511d7e550c'"
    val sql = "select bc.channelid,bc.channelname,bc.createuser,ci.imgid,ci.imgurl from zhilian_test.basechannel bc join zhilian_test.channelimg ci on bc.channelid=ci.channelid and bc.channelid='001005d0-89a5-45ed-b5ee-42feef26ac97' join zhilian_test.equipment"
